...
public class CategoryController {
    ...
    public ResponseVo<List<CategoryEntity>> queryCategory(@PathVariable("parentId")Long id){

        List<CategoryEntity> categoryEntityList=categoryService.queryCategory(id);
